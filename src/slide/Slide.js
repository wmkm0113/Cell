        ...
        constructor(element) {
            ...
            if (_length > 1) {
                switch (this._options.slideType) {
                    case "Scroll":
                        this._element.bindEvent("mouseover", this.pause);
                        this._element.bindEvent("mouseout", this.resume);
                        break;
                    case "Zoom":
                        for (i = 0 ; i < _length ; i++) {
                ...
                this._element.bindEvent("", Slide.eventProcess(this, true));
                this._element.bindEvent("", Slide.eventProcess(this, false));
            }
        }
